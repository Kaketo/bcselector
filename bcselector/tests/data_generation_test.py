...
class TestMatrixGenerator(unittest.TestCase):
    ...
    def test_seed_repetition(self):
        ...
        # When
        mg = MatrixGenerator()
        X_1, y_1, costs_1 = mg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed,
        )
        X_2, y_2, costs_2 = mg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed,
        )
        X_3, y_3, costs_3 = mg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed + 1,
...
class TestDataFrameGenerator(unittest.TestCase):
    ...
    def test_seed_repetition(self):
        ...
        X_1, y_1, costs_1 = dg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed,
        )
        X_2, y_2, costs_2 = dg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed,
        )
        X_3, y_3, costs_3 = dg.generate(
            n_rows=n_rows,
            n_basic_cols=n_cols,
            noise_sigmas=[0.9, 0.8, 0.3, 0.1],
            seed=seed + 1,
