...
class TestMIM(unittest.TestCase):
    def test_empty_imput(self):
        ...
        with self.assertRaises(AssertionError):
            mim(empty_matrix, diverse_target, 0)
    ...
    def test_too_high_candidate_index(self):
        ...
        too_high_index = 51
        with self.assertRaises(AssertionError):
            mim(zeros_matrix, diverse_target, too_high_index)
    ...
    def test_theoretical_value(self):
        ...
        self.assertAlmostEqual(
            mim(integer_matrix, diverse_target, candidate_index),
            mutual_information(diverse_target, integer_matrix[:, candidate_index]),
            places=5,
        )
    ...
    def test_one_class_target(self):
        ...
        candidate_index = 1
        self.assertAlmostEqual(
            mim(integer_matrix, one_class_target, candidate_index), 0.0, places=5
        )
...
class TestMIFS(unittest.TestCase):
    ...
    def test_no_beta_provided(self):
        ...
        with self.assertWarns(Warning):
            mifs(zeros_matrix, diverse_target, prev_variable_index, candidate_index)
