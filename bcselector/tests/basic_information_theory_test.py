...
class TestEntropy(unittest.TestCase):
    def test_empty_input(self):
        empty_list = []
        with self.assertRaises(AssertionError): entropy(empty_list)
...
class TestConditionalEntropy(unittest.TestCase):
    def test_empty_input(self):
        input = []
        condition = []
        with self.assertRaises(AssertionError): entropy_conditional(input, condition)

    def test_one_number_input(self):
        self.assertEqual(entropy_conditional([1], [0]), 0.0)
    ...
    def test_list_input(self):
        ...
        self.assertIsInstance(entropy_conditional(list_input, condition), float)

    def test_nparray_input(self):
        np_input = np.array([1, 2, 3, 5, 432, 42, 31234, 342, 34])
        condition = np.array([1, 1, 1, 1, 0, 0, 0, 0, 0])
        self.assertIsInstance(entropy_conditional(np_input, condition), float)
    ...
    def test_theoretical_output(self):
        ...
        self.assertAlmostEqual(entropy_conditional(input_1, cond_1), proper_value_1, places=3)

        input_2 = [0, 0, 0, 0, 1, 0, 0, 0, 0]
        cond_2 = [1, 1, 1, 1, 0, 0, 0, 0, 0]
        proper_value_2 = 0.2780013
        self.assertAlmostEqual(entropy_conditional(input_2, cond_2), proper_value_2, places=3)

        # Entropy must be higher in more diverse vectors
        self.assertGreater(entropy_conditional(input_1, cond_1), entropy_conditional(input_2, cond_2))
...
class TestConditionalMutualInformation(unittest.TestCase):
    def test_empty_input(self):
        ...
        vector_2 = []
        condition = []
        with self.assertRaises(AssertionError): mutual_information_conditional(vector_1, vector_2, condition)

    def test_one_number_input(self):
        self.assertEqual(mutual_information_conditional([1], [0], [1]), 0.0)
    ...
    def test_different_input_sizes(self):
        ...
        condition = [0, 0, 0, 1]
        with self.assertRaises(AssertionError): mutual_information_conditional(vector_1, vector_2, condition)
        with self.assertRaises(AssertionError): mutual_information_conditional(vector_2, vector_1, condition)

    def test_list_input(self):
        vector_1 = [1, 2, 3, 5, 432, 42, 31234, 342, 34]
        vector_2 = [1, 1, 1, 1, 0, 0, 0, 0, 0]
        condition = [0, 0, 0, 0, 1, 0, 0, 0, 0]
        self.assertIsInstance(mutual_information_conditional(vector_1, vector_2, condition), float)
    ...
    def test_commutative_property(self):
        ...
        self.assertAlmostEqual(mutual_information_conditional(input_1, input_2, condition),
                               mutual_information_conditional(input_2, input_1, condition), places=5)
...
class TestCombinedMutualInformation(unittest.TestCase):
    def test_empty_input(self):
        ...
        with self.assertRaises(AssertionError):
            mutual_information_combined(vector_1, vector_2, condition)
    ...
    def test_different_input_sizes(self):
        ...
        with self.assertRaises(AssertionError):
            mutual_information_combined(vector_1, vector_2, condition)
        with self.assertRaises(AssertionError):
            mutual_information_combined(vector_2, vector_1, condition)

    def test_list_input(self):
        vector_1 = [1, 2, 3, 5, 432, 42, 31234, 342, 34]
        vector_2 = [1, 1, 1, 1, 0, 0, 0, 0, 0]
        condition = [0, 0, 0, 0, 1, 0, 0, 0, 0]
        self.assertIsInstance(mutual_information_combined(vector_1, vector_2, condition), float)
    ...
    def test_commutative_property(self):
        ...
        self.assertAlmostEqual(mutual_information_combined(input_1, input_2, condition),
                               mutual_information_combined(input_2, input_1, condition), places=5)
