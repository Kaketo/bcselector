...
class TestConditionalEntropy(unittest.TestCase):
    ...
    def test_theoretical_output(self):
        ...
        self.assertAlmostEqual(
            conditional_entropy(input_1, cond_1), proper_value_1, places=3
        )
        ...
        self.assertAlmostEqual(
            conditional_entropy(input_2, cond_2), proper_value_2, places=3
        )

        # Entropy must be higher in more diverse vectors
        self.assertGreater(
            conditional_entropy(input_1, cond_1), conditional_entropy(input_2, cond_2)
        )
...
class TestMutualInformation(unittest.TestCase):
    ...
    def test_theoretical_output(self):
        ...
        self.assertAlmostEqual(
            mutual_information(input_1, input_2), proper_value_1, places=3
        )
        ...
        self.assertAlmostEqual(
            mutual_information(input_3, input_4), proper_value_2, places=3
        )
    ...
    def test_commutative_property(self):
        ...
        self.assertEqual(
            mutual_information(input_1, input_2), mutual_information(input_2, input_1)
        )
...
class TestConditionalMutualInformation(unittest.TestCase):
    def test_empty_input(self):
        ...
        condition = []
        with self.assertRaises(AssertionError):
            conditional_mutual_information(vector_1, vector_2, condition)
    ...
    def test_different_input_sizes(self):
        ...
        with self.assertRaises(AssertionError):
            conditional_mutual_information(vector_1, vector_2, condition)
        with self.assertRaises(AssertionError):
            conditional_mutual_information(vector_2, vector_1, condition)
    ...
    def test_list_input(self):
        ...
        self.assertIsInstance(
            conditional_mutual_information(vector_1, vector_2, condition), float
        )
    ...
    def test_commutative_property(self):
        ...
        self.assertAlmostEqual(
            conditional_mutual_information(input_1, input_2, condition),
            conditional_mutual_information(input_2, input_1, condition),
            places=5,
        )
    ...
    class TestCombinedMutualInformation(unittest.TestCase):
        ...
        def test_commutative_property(self):
            ...
            self.assertAlmostEqual(
                mutual_information_combined(X1=X1, X2=X2, Y=Y),
                mutual_information_combined(X1=X2, X2=X1, Y=Y),
                places=5,
            )
        ...
        def test_theoretical_output(self):
            ...
            self.assertAlmostEqual(
                mutual_information_combined(X1=X1, X2=X2, Y=Y), proper_value_1, places=3
            )
            ...
            self.assertAlmostEqual(
                mutual_information_combined(X1=X1, X2=X2, Y=Y), proper_value_2, places=3
            )
